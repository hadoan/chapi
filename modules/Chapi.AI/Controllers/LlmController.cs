...
namespace Chapi.AI.Controllers
{
    ...
    public class LlmController : ControllerBase
    {
        ...
        public Task<DetectionResponseDto> DetectByCode([FromBody] DetectByCodeRequest req, System.Threading.CancellationToken ct)
        {
            ...
            return Task.FromResult(new DetectionResponseDto(
                DetectSource: "ai-by-code",
                DetectConfidence: 0.95,
                Profile: new DetectedProfile(
                    Type: "OAuth2",
                    EnvironmentKey: "ENVIRONMENT_KEY",
                    Parameters: new DetectedParameters(
                        ...
                        UsernameRef: "CREDENTIALS_EMAIL",
                        PasswordRef: "CREDENTIALS_PASSWORD",
                        CustomLoginUrl: null,
                        CustomBodyType: "form",
                        CustomUserKey: null,
                        CustomPassKey: null,
                    ...
                    Injection: new InjectionPreview(
                        Mode: "Header",
                        Name: "Authorization",
                        Format: "Bearer"
                    ),
                    Secrets: new List<DetectedSecret>
                    {
                        new DetectedSecret(
                            ...
                            SecretRef: "EMAIL_SECRET",
                            Notes: null
                        ),
                        new DetectedSecret(
                            Key: "CREDENTIALS_PASSWORD",
                            SecretRef: "PASSWORD_SECRET",
                            Notes: null
                        )
                    },
                    TokenRequest: new DetectedTokenRequest(
                        Method: "POST",
                        Url: "/connect/token",
                        ...
                        Body: new DetectedBody(
                            Kind: "form",
                            Value: new Dictionary<string, object>
                            {
                                ["grant_type"] = "password",
                                ["client_id"] = "spa-client",
                                ["username"] = "CREDENTIALS_EMAIL",
                                ["password"] = "CREDENTIALS_PASSWORD",
                                ["scope"] = "openid email profile roles"
                            }
                        ),
                        Expect: new DetectedExpect(
                            Status: 200,
                            TokenJsonPath: "access_token"
                        )
                    )
