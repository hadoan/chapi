...
namespace Chapi.Api.Migrations
{
    ...
    [Migration("20250914115111_UpdateRunModels")]
    partial class UpdateRunModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthProfiles.Domain.AuthProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<double>("DetectConfidence")
                        .HasColumnType("double precision");

                    b.Property<string>("DetectSource")
                        .IsRequired()
                        .HasMaxLength(200)
                    ...
                    b.Property<string>("InjectionFormat")
                        .IsRequired()
                        .HasMaxLength(1000)
                    ...
                    b.HasIndex("ProjectId", "ServiceId", "EnvironmentKey")
                        .IsUnique();

                    b.HasIndex("ServiceId", "EnvironmentKey", "Enabled");

                    b.ToTable("AuthProfiles", (string)null);
                });

            modelBuilder.Entity("AuthProfiles.Domain.AuthProfileSecretRef", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AuthProfileId", "Key")
                        .IsUnique();

                    b.ToTable("AuthProfileSecretRefs", (string)null);
                });

            modelBuilder.Entity("Chapi.ApiSpecs.Domain.ApiSpec", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ApiSpecs", "ApiSpecs");
                });

            modelBuilder.Entity("Chapi.EndpointCatalog.Domain.ApiEndpoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<JsonDocument>("Security")
                        .IsRequired()
                        .HasColumnType("jsonb");

                    b.Property<JsonDocument>("Servers")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.HasIndex("SpecId", "Method", "Path")
                        .IsUnique();

                    b.ToTable("ApiEndpoints", "EndpointCatalog");
                });
            ...
            modelBuilder.Entity("RunPack.Domain.RunPack", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("RunPacks", (string)null);
                });

            modelBuilder.Entity("RunPack.Domain.RunPackFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("RunPackId");

                    b.HasIndex("RunPackId", "FileId")
                        .IsUnique();

                    b.ToTable("RunPackFiles", (string)null);
                });

            modelBuilder.Entity("RunPack.Domain.RunPackInput", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("EndpointsContext")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("FileRolesJson")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("RoleContextsJson")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("RunPackInputs", (string)null);
                });

            modelBuilder.Entity("Runs.Domain.Run", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SuiteName", "Version");

                    b.ToTable("Runs", (string)null);
                });

            modelBuilder.Entity("Runs.Domain.RunEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Runs.Domain.RunStep", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AuthProfiles.Domain.AuthProfile", b =>
                {
                    b.OwnsOne("AuthProfiles.Domain.AuthProfile+Params", "Parameters", b1 =>
                        {
                            b1.Property<Guid>("AuthProfileId")
                                .HasColumnType("uuid");

                            b1.Property<string>("Audience")
                                .HasColumnType("text");

                            b1.Property<string>("AuthorizationUrl")
                                .HasColumnType("text");

                            b1.Property<string>("ClientId")
                                .HasColumnType("text");

                            b1.Property<string>("ClientSecretRef")
                                .HasColumnType("text");

                            b1.Property<string>("CustomBodyType")
                                .HasColumnType("text");

                            b1.Property<string>("CustomLoginUrl")
                                .HasColumnType("text");

                            b1.Property<string>("CustomPassKey")
                                .HasColumnType("text");

                            b1.Property<string>("CustomUserKey")
                                .HasColumnType("text");

                            b1.Property<string>("PasswordRef")
                                .HasColumnType("text");

                            b1.Property<string>("Scopes")
                                .HasColumnType("text");

                            b1.Property<string>("TokenJsonPath")
                                .HasColumnType("text");

                            b1.Property<string>("UsernameRef")
                                .HasColumnType("text");

                            b1.HasKey("AuthProfileId");

                            b1.ToTable("AuthProfiles");
            ...
            modelBuilder.Entity("AuthProfiles.Domain.AuthProfileSecretRef", b =>
                {
                    b.HasOne("AuthProfiles.Domain.AuthProfile", "Profile")
                        .WithMany("SecretRefs")
                        .HasForeignKey("AuthProfileId")
            ...
            modelBuilder.Entity("RunPack.Domain.RunPackFile", b =>
                {
                    b.HasOne("ShipMvp.Domain.Files.File", "File")
                        .WithMany()
                        .HasForeignKey("FileId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("RunPack.Domain.RunPack", null)
                        .WithMany("Files")
                        .HasForeignKey("RunPackId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RunPack.Domain.RunPackInput", b =>
                {
                    b.HasOne("RunPack.Domain.RunPack", null)
                        .WithOne("Input")
                        .HasForeignKey("RunPack.Domain.RunPackInput", "RunPackId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
